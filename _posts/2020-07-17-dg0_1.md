...
comments: true
image: images/math/differential-geometry/dg0_1.png
---
...
So, isormophisms just mean the way they sound - two entities are isomoorphic if they are identical; they behave the same way. So if there exists a natural isomorphism between two functors then they are both essentially *the same*.
